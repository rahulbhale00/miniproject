...
const RealTimeFlameChart = () => {
  ...
  const bgColor = isWarning ? "bg-red-100 border-red-500" : "bg-white border-gray-300";
  ...
  const options = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: "Real-Time Flame Sensor Data",
        color: "#333",
  ...
  return (
    <div className={`flex flex-col items-center justify-center p-6 rounded-lg shadow-lg border ${bgColor} w-full h-[450px]`}>
